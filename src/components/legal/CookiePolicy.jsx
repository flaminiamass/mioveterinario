...
export default function CookiePolicy({ onBack }) {
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "16px 20px 40px" }}>
      ...
      >
        <b>✅ Versione demo:</b> In questa versione di sviluppo, MioVeterinario{" "}
        <b>non utilizza cookie di profilazione, tracciamento, analytics o marketing</b>. Non vengono installati cookie
        di terze parti. L'app utilizza esclusivamente lo stato in-memory del browser (React state) per il funzionamento
        della demo.
      </div>

      <Section title="1. Cosa sono i cookie">
        <p>
          I cookie sono piccoli file di testo che un sito web salva sul tuo dispositivo durante la navigazione. Possono
          essere "di sessione" (cancellati alla chiusura del browser) o "persistenti" (conservati per un periodo
          definito).
        </p>
      </Section>
      ...
      <Section title="2. Cookie tecnici (necessari)">
        <p>
          I cookie tecnici sono necessari per il funzionamento del sito e non richiedono il tuo consenso. MioVeterinario
          utilizzerà in produzione solo i seguenti cookie tecnici:
        </p>
        <div
          style={{
            marginTop: 10,
        ...
        <p style={{ marginTop: 8, fontSize: fontSize.sm, color: colors.textMuted }}>
          I cookie tecnici elencati sono a titolo indicativo e saranno definiti in dettaglio con il team di sviluppo
          prima del go-live.
        </p>
      </Section>

      <Section title="3. Cookie analitici e di profilazione">
        <p>In questa versione demo non sono presenti cookie analitici o di profilazione.</p>
        <p style={{ marginTop: 8 }}>
          Prima del go-live, se si intende integrare strumenti di analytics (es. Google Analytics, Plausible, Mixpanel,
          Hotjar o simili), sarà necessario:
        </p>
        <ul style={{ paddingLeft: 20, marginTop: 6 }}>
          <li>
            Verificare se lo strumento rientra nelle esenzioni per analytics in forma aggregata e anonimizzata (Linee
            guida Garante 2021).
          </li>
          <li>
            In caso contrario, attivare un banner cookie che permetta di rifiutare facilmente i cookie non tecnici prima
      ...
      <Section title="4. Google Fonts e asset di terze parti">
        <p>
          In questa versione demo non vengono caricati Google Fonts, font di terze parti o asset CDN che trasmettono
          l'IP dell'utente a server esteri. Se in futuro venissero integrati, occorre valutare l'impatto privacy e le
          basi giuridiche appropriate. [DA VERIFICARE prima del go-live]
        </p>
      </Section>
      ...
      <Section title="5. Come gestire i cookie">
        ...
        <p style={{ marginTop: 8 }}>
          Disabilitare i cookie tecnici potrebbe compromettere il funzionamento del servizio.
        </p>
      </Section>

      <Section title="6. Aggiornamenti">
        <p>
          Questa Cookie Policy può essere aggiornata. Le modifiche saranno indicate con la data di aggiornamento in cima
          al documento. [DA VALIDARE CON LEGALE]
        </p>
      </Section>

      <Section title="7. Contatti">
        <p>
          Per domande sui cookie e sul trattamento dei dati: <b>[email privacy]</b>
        </p>
      </Section>
