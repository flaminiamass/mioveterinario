  ...
  return (
    <div style={{ background: colors.headerGradient, color: colors.white, padding: "18px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
        {onNotifications && (
          <button onClick={onNotifications} aria-label="Notifiche" style={{ background: "rgba(255,255,255,0.18)", border: "none", borderRadius: radius.md, color: colors.white, cursor: "pointer", padding: "6px 10px", minHeight: 36, display: "flex", alignItems: "center", gap: 4, fontSize: fontSize.sm, fontWeight: 600, position: "relative" }}>
            🔔
            {unreadCount > 0 && (
              <span style={{ position: "absolute", top: -2, right: -4, background: "#EF4444", color: "#fff", fontSize: 9, fontWeight: 800, minWidth: 16, height: 16, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", padding: "0 3px", lineHeight: 1 }}>
