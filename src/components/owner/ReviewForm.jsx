      ...
      <Card style={{ marginTop: 12 }}>
        ...
        <div style={{ fontSize: 32, cursor: "pointer", marginTop: 4 }}>
          {[1, 2, 3, 4, 5].map((n) => (
            <span
              ...
              style={{ color: n <= rating ? colors.star : colors.borderLight }}
            >
              ★
            </span>
          ))}
        ...
        >
          ...
          <ul style={{ margin: "6px 0 0", paddingLeft: 18 }}>
            <li>
              Le recensioni provengono da appuntamenti completati e sono <b>pubbliche</b> sul profilo del veterinario.
            </li>
            <li>
              <b>Non inserire</b> dati sanitari dell'animale, diagnosi, farmaci o dati personali nel commento — per
              questo esiste il referto clinico.
            </li>
          </ul>
        </div>
        <label
        ...
        <textarea
          ...
          rows={4}
          placeholder="Com'è andata la visita?"
        ...
        <div
          style={{
            ...
            color: comment.length > 450 ? colors.danger || "#E53E3E" : colors.textMuted,
            marginTop: 2,
          }}
        >
          {comment.length}/500
