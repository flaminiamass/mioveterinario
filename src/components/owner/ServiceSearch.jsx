...
export default function ServiceSearch({ onBook }) {
  ...
  if (selectedService) {
    return (
      <>
        <Btn small variant="light" onClick={() => setSelectedService(null)}>
          ← Torna ai servizi
        </Btn>
        <SectionTitle style={{ marginTop: 12 }}>
          {selectedService.emoji} {selectedService.name}
        </SectionTitle>
        <p style={{ fontSize: fontSize.md, color: colors.textSecondary, margin: "0 0 14px" }}>{selectedService.desc}</p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {s.desc && (
                            <div style={{ fontSize: fontSize.sm, color: colors.textMuted, marginTop: 2 }}>{s.desc}</div>
                          )}
                        </div>
